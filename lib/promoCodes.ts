...
export { getFcAdvocatePricing, isFcPromoDayActive } from '@/lib/basecampExperience';
...
/** Founders Club codes FC000001–FC000500 (single-use, VIP rate varies by promo day, payment still required). */
