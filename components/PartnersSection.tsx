    ...
    >
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className={`mt-16 text-center ${isPartnersVisible ? 'animate-fade-in' : 'animate-fade-out opacity-0'}`} style={{ animationDelay: '0.8s' }}>
          ...
          <button className="bg-gradient-to-r from-orange-600 to-orange-500 text-white px-8 py-3 rounded-full font-semibold hover:from-orange-700 hover:to-orange-600 transition-all transform hover:scale-105 shadow-lg font-fira-sans">
            Partner With Us
          </button>
        </div>
      </div>
