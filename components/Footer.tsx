        ...
        <div className="py-12 lg:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed font-sweet-sans mb-4">
                Empowering athletes in Asia through premier running events and leadership development programs.
              </p>
            ...
            {/* Quick Links */}
            <div>
              <h3 className="text-lg font-bold mb-4 font-druk text-orange-500">Quick Links</h3>
            ...
            {/* Contact Info */}
            <div>
              <h3 className="text-lg font-bold mb-4 font-druk text-orange-500">Contact Us</h3>
              <ul className="space-y-3">
            ...
            {/* Event Info */}
            <div>
              <h3 className="text-lg font-bold mb-4 font-druk text-orange-500">Event Details</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-orange-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
